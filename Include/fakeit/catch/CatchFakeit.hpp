...
public:
              ...
              Catch::ResultWas::OfType resultWas = Catch::ResultWas::OfType::ExpressionFailed)
    {
        ...
        INTERNAL_CATCH_CATCH(catchAssertionHandler) { INTERNAL_CATCH_REACT(catchAssertionHandler) }
    }
...
protected:
    fakeit::EventHandler& accessTestingFrameworkAdapter() override { return _catchAdapter; }

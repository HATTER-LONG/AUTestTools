...
#define PyType_CheckExact(op) (Py_TYPE(op) == &PyType_Type)
    ...
    PyAPI_FUNC(PyObject*) PyType_GenericNew(struct _typeobject*, PyObject*, PyObject*);
...
#define Py_TPFLAGS_DEFAULT (Py_TPFLAGS_HAVE_STACKLESS_EXTENSION | Py_TPFLAGS_HAVE_VERSION_TAG | 0)

...
- 可能你遇到了和我一样的困扰，就是想要调试一个关于源码 AST 树相关的功能，需要现在 llvm-project 项目中将你的功能模块编译成库，然后在链接到你的项目中去，不说llvm-project 体积巨大，打开项目浪费时间，单单这操作也是够繁琐了。因此，这里我整理了下如何使用源码在你的项目中去编译。
